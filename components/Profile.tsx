    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="md:flex md:items-center md:justify-between mb-8">
        <div className="flex-1 min-w-0">
          <h2 className="text-2xl font-bold leading-7 text-[#1e1b4b] sm:text-3xl sm:truncate">
            My Dashboard
          </h2>
        </div>
        <div className="mt-4 flex md:mt-0 md:ml-4">
          <button
            ...
            className="ml-3 inline-flex items-center px-6 py-2.5 border border-transparent rounded-full shadow-md text-sm font-bold text-white bg-[#312e81] hover:bg-[#1e1b4b] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#312e81] transition-colors"
          >
            New Estimate
          </button>
        </div>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3 mb-8">
        ...
        <div className="bg-white overflow-hidden shadow-lg rounded-xl border border-gray-100">
          <div className="p-5">
            <div className="flex items-center">
              <div className="flex-shrink-0 bg-[#312e81] rounded-lg p-3">
        ...
        <div className="bg-white overflow-hidden shadow-lg rounded-xl border border-gray-100">
          <div className="p-5">
            <div className="flex items-center">
              <div className="flex-shrink-0 bg-emerald-600 rounded-lg p-3">
            ...
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd>
                    <div className="text-lg font-bold text-gray-900">~$300k</div>
                  </dd>
                </dl>
              </div>
            </div>
            ...
            <li key={est.id} className="px-6 py-4 hover:bg-gray-50 transition-colors cursor-pointer group">
              <div className="flex items-center justify-between">
                ...
                <div className="flex flex-col items-end">
                  ...
                  <span className={`text-xs px-2 py-0.5 rounded-full font-medium ${est.status === 'Complete' ? 'bg-gray-100 text-gray-600' : 'bg-yellow-100 text-yellow-800'}`}>
                    {est.status}
                  </span>
                </div>
              </div>
